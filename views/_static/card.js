var pile = [
	["gnome", "magnet", "dumbell", "pumpkin", "diamond", "badge", "oops", "hand"],
	["hand", "camera", "starfish", "plunger", "pig", "racecar", "toothbrush", "fork"],
	["pumpkin", "trumpet", "owl", "paintbrush", "high heel", "balloon", "dynamite", "racecar"],
	...
	["jack", "dumbell", "trumpet", "acorn", "headphone", "pig", "scorpion", "pin"],
	...
	["tomato", "hand", "acorn", "high heel", "snail", "binky", "jet", "sandal"],
	...
	["racecar", "tower", "planet", "duck", "dumbell", "tomato", "cupcake", "hydrant"],
	["camera", "scorpion", "pumpkin", "sandal", "can", "cupcake", "rocket", "wheel"],
	["tower", "high heel", "rocket", "potato", "jack", "boomerang", "oops", "starfish"],
	["camera", "diamond", "horseshoe", "snail", "trumpet", "potato", "hydrant", "ace"],
	["go", "boomerang", "bat", "trumpet", "cupcake", "hand", "comb", "lolipop"],
	["bat", "jack", "sandal", "planet", "balloon", "gnome", "ace", "plunger"],
	["well", "duck", "starfish", "binky", "owl", "bat", "diamond", "scorpion"],
	["scooter", "starfish", "snail", "can", "lolipop", "balloon", "yay", "dumbell"],
	...
	["tomato", "diamond", "lighthouse", "pin", "rocket", "lolipop", "dynamite", "plunger"],
	...
	["rocket", "comb", "owl", "hourglass", "toothbrush", "dumbell", "jet", "ace"],
	["lolipop", "pig", "tower", "hammer", "sandal", "owl", "magnet", "horseshoe"],
	["sandal", "fork", "dumbell", "butterfly", "potato", "go", "dynamite", "well"],
	["magnet", "go", "yay", "hydrant", "hourglass", "plunger", "high heel", "scorpion"],
	["well", "horseshoe", "gnome", "toothbrush", "pin", "high heel", "cupcake", "scooter"],
	["dumbell", "banana", "hammer", "watermelon", "camera", "lighthouse", "high heel", "bat"],
	["jack", "paintbrush", "cupcake", "yay", "diamond", "hammer", "jet", "fork"],
	["wheel", "paintbrush", "plunger", "boomerang", "clip", "binky", "horseshoe", "dumbell"],
	["banana", "clip", "jet", "gnome", "racecar", "lolipop", "potato", "scorpion"],
	...
	["boomerang", "tomato", "ace", "wheel", "banana", "pig", "pumpkin", "yay"],
	...
	["butterfly", "pig", "clip", "comb", "diamond", "planet", "can", "high heel"],
	["duck", "watermelon", "rocket", "pig", "go", "snail", "gnome", "paintbrush"],
	["magnet", "starfish", "ace", "clip", "acorn", "cupcake", "watermelon", "dynamite"],
	["high heel", "badge", "wheel", "headphone", "duck", "ace", "lolipop", "fork"],
	["pumpkin", "hydrant", "jack", "lolipop", "watermelon", "toothbrush", "binky", "butterfly"],
...
var symbol =
	{	ace : '_static/pic/acecard.png' ,
		...
		lolipop : '_static/pic/lolipop.png' ,
